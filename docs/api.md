...
Bienvenido a la documentación de la API para la **Candidate Profile Intelligence Platform**. Esta API está construida con FastAPI y permite gestionar perfiles de candidatos, incluyendo su creación, recuperación, actualización y eliminación.
